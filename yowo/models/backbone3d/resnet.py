...
from .config import MODEL_URLS_RESNET
from .types import RESNET_VERSION
...
# build 3D resnet
def build_resnet_3d(model_name: RESNET_VERSION = 'resnet18', pretrained: bool = False):
    validate_literal_types(model_name, RESNET_VERSION)
