...
from .config import MODEL_URLS_RESNEXT
from .types import RESNEXT_VERSION
...
class ResNeXt(nn.Module):
    ...
    def __init__(
        ...
        self.layer1 = self._make_layer(
            block, 128, layers[0], shortcut_type,
            cardinality
        )
...
# build 3D resnet
def build_resnext_3d(model_name: RESNEXT_VERSION = 'resnext101', pretrained: bool = True):
    validate_literal_types(model_name, RESNEXT_VERSION)
