...
from yowo.models.basic.utils import (
    get_activation,
    get_norm
)
...
class ShuffleNetV2(nn.Module):
    def __init__(
        self,
        model_name: SHUFFLENETV2 = 'shufflenet_v2_x1_0',
        out_stages=(2, 3, 4),
...
def build_shufflenetv2(model_name: SHUFFLENETV2 = 'shufflenet_v2_x1_0'):
    ...
    """
    validate_literal_types(model_name, SHUFFLENETV2)
    backbone = ShuffleNetV2(model_name=model_name)
...
if __name__ == '__main__':
    import time
    model, feats = build_backbone(model_name='shufflenet_v2_x1_0')
