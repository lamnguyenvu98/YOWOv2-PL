...
def build_channel_encoder(head_act: ACTIVATION, head_norm: NORM, in_dim: int, out_dim: int):
...
def build_spatial_encoder(head_act: ACTIVATION, head_norm: NORM, in_dim: int, out_dim: int):
